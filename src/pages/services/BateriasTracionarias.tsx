...
import { CheckCircle2, Wrench, ShieldCheck, Target } from "lucide-react";

export function BateriasTracionarias() {
  const data = servicosData.bateriasTracionarias;
  ...
  return (
    <PageTransition>
      ...
      <ServiceMediaShowcase serviceKey="baterias-tracionarias" />
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
            <div className="bg-zinc-50 p-8 rounded-xl border border-zinc-200">
              <h3 className="text-2xl font-bold text-zinc-900 mb-6">Serviços Oferecidos</h3>
            ...
            <div className="bg-zinc-50 p-8 rounded-xl border border-zinc-200">
              <h3 className="text-2xl font-bold text-zinc-900 mb-6">Diferenciais Técnicos</h3>
              <ul className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div>
              ...
              <div className="bg-white border border-zinc-200 rounded-xl overflow-hidden">
                {data.garantias.map((item, index) => (
                  <div key={index} className="p-4 border-b border-zinc-100 last:border-0 flex items-center">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-3">
                {data.indicadoPara.map((item, index) => (
                  <span key={index} className="px-4 py-2 bg-zinc-100 text-zinc-800 rounded-full font-medium text-sm">
                    {item}
                  </span>
                ))}
              </div>
